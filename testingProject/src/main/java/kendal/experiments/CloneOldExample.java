...
public class CloneOldExample {
    ...
    @Clone(transformer = CsvTransformer.class, onMethod = {@RequestMapping(value = "/method1/csv", method = "POST")})
    @RequestMapping(value = "/method1", method = "POST")
    public List<Object> method1() {
        return new ArrayList<>();
    }

    @Clone(transformer = CsvTransformer.class, onMethod = {@RequestMapping(value = "/method2/csv", method = "POST")})
    @RequestMapping(value = "/method2", method = "POST")
    public List<Object> method2() {
        return new ArrayList<>();
    }

    @Clone(transformer = CsvTransformer.class, onMethod = {@RequestMapping(value = "/method3/csv", method = "POST")})
